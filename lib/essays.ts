...
const essays: Essay[] = [
  {
    ...
    closing: "We are still running pop-ups. The menu keeps evolving. The thesis hasn't.",
  },
  {
    ...
    closing: "I lift four days a week. I still take notes. The notebook is smaller now.",
  },
  {
    ...
    closing: "Vagabond is still running. Bigger now. Still doesn't look like it's trying.",
  },
  {
    ...
    closing: "I think about this project every time I walk past a camera that costs more than my rent.",
  },
  {
    ...
    closing: "I am no longer in prep. The notebook habit stayed.",
  },
  {
    ...
    closing: "If you ask me what I do, this is the answer underneath the other answers.",
  },
];
